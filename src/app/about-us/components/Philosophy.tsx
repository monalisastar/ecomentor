...
export default function Philosophy() {
  ...
  return (
    <section className="relative z-10 px-6 md:px-20 py-24 max-w-7xl mx-auto text-white">
      ...
      <p className="text-center text-gray-300 max-w-3xl mx-auto mb-14 relative z-10">
        Eco-Mentor is more than a learning platform — it’s a belief system. We design every course, tool,
