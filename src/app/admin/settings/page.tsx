 ...
 * ---------------------------------------------------------
 * Centralized admin panel to manage:
 * - Platform info and branding (GeneralSettingsPanel)
 * - Certificate defaults (CertificateDefaultsPanel)
 * - System controls and toggles (SystemControlsPanel)
 */
